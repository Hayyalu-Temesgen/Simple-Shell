...
/**
 * input_buff - this function will buffer chained commands
 * @info: the parameter
 * @buf: the address
 * @len: the address
...
/**
 * get_input - this function will get a line minus the newline
 * @info: the parameter
 * Return: will return the bytes
 */
...
/**
 * read_buff - this function will read a buffer
 * @info: the parameter
 * @buf: the buffer
 * @i: size of the buffer
 * Return: will return r
 */
...
/**
 * _getline - this function will get the next line of input
 * @info: the parameter
...
/**
 * sigintHandler - this function will block ctrl-C
